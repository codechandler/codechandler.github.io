...
function writeData(responseText, id) {
    ...
    for (i=0; i<myObj.projects.length; i++) {
        ...
        displayText += rank + "\" style=\"order:" + order + "\"> <h2>" + title + "</h2> <p>" + "&emsp;&emsp;" + projectInfo + "</p> <div class=\"center\"> <img src=\"" + primaryImg + "\" alt=\"\" style=\"width:100%; height:auto\"> <div class=\"center\">";
        ...
        displayText += "</div> <a class=\"active\" id=\"expanded" + order + "Link\" onclick=\"expandText('expanded" + order + "')\" style=\"color:blue;cursor:pointer;display:inline\"><u>More...</u></a></div><div id=\"expanded" + order + "\" style=\"display:none\"> <p>" + "&emsp;&emsp;" + description + "</p> <div class=\"center\">"; 
